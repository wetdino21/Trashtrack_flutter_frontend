        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              Text(
                'Please enter the email you registered with to change your password',
                style: TextStyle(
                  fontSize: 16,
                  color: Colors.white,
                ),
                ...
                onPressed: () {
                  if (_formKey.currentState?.validate() == true) {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => CheckEmailChangePass(),
                      ),
                    );
                  }
                },
...
// Check Email Screen
class CheckEmailChangePass extends StatefulWidget {
  @override
  _CheckEmailScreenState createState() => _CheckEmailScreenState();
}

class _CheckEmailScreenState extends State<CheckEmailChangePass> {
  final _formKey = GlobalKey<FormState>();
...
class ChangeNewPass extends StatefulWidget {
  @override
  _ChangeNewPassState createState() => _ChangeNewPassState();
}
